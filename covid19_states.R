...
#Create data frame for cases from states
...
#Plot cumulative cases in states
...
#qp4 <- qp4 + geom_smooth(aes(x=date, y=mavg), color="blue", method="auto", fill="lightsteelblue", size=lsize)
